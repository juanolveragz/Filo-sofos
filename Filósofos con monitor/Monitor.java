...
class Monitor {
	 ...
	 */
	public synchronized void levantaCubiertos(int idFilosofo) throws InterruptedException/* Completar código */ {
		...
		while (losVecinosComen(idFilosofo)) {
			/*
			 * Mientras los vecinos comen tiene que esperar.
	...
	public synchronized void bajarCubiertos(int idFilosofo) {
		...
		/*
		 * Notificar a todos los filosofos que estan alrededor que los cubiertos estan disponibles.
		 */
		notifyAll();
	}
}
